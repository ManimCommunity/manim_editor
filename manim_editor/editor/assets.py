...
class IconNormal(manim.VGroup):
    def __init__(self):
        ...
        icon_normal = manim.SVGMobject(os.path.join(get_config().STATIC_DIR, "img", "play_btn.svg"))
...
class IconSkip(manim.VGroup):
    def __init__(self):
        manim.VGroup.__init__(self)
        icon_skip = manim.SVGMobject(os.path.join(get_config().STATIC_DIR, "img", "wind.svg"))
        self.add(icon_skip)
...
class IconLoop(manim.VGroup):
    def __init__(self):
        manim.VGroup.__init__(self)
        icon_loop = manim.SVGMobject(os.path.join(get_config().STATIC_DIR, "img", "arrow_clockwise.svg"))
        self.add(icon_loop)
...
class IconCompleteLoop(manim.VGroup):
    def __init__(self):
        manim.VGroup.__init__(self)
        icon_completeloop = manim.SVGMobject(os.path.join(get_config().STATIC_DIR, "img", "hourglass_split.svg"))
